	...
	function (t, e, i) {
		...
		(r.prototype.setInitialized = function (t) {
			...
			(s.loadJson = function (t) {
				...
				if (
					(e.setFadeIn(
						parseInt(i.fade_in) > 0 ? parseInt(i.fade_in) : 1e3
					),
					e.setFadeOut(
						parseInt(i.fade_out) > 0 ? parseInt(i.fade_out) : 1e3
					),
					null == i.params)
				)
					return e;
				...
				for (var a = 0; a < n; a++) {
					...
					if (
						...
						var p;
						0 == (p = null == _.def ? 1 : parseFloat(_.def)) &&
							(p = 1),
							(l /= p);
					}
					var c = new o();
			...
			(h.load = function (t) {
				for (
					var e = new h(),
						i = f
							.getPlatformManager()
							.jsonParseFromBytes(t).physics_hair,
						r = i.length,
						s = 0;
					s < r;
					s++
				...
				for (var i = 0; i < e.length; i++) {
					...
					if (null != r.link && !(r.partsIndex < 0))
						for (
							...
							var n = r.link[o];
							n.partsIndex < 0 ||
								t.setPartsOpacity(n.partsIndex, s);
						}
				}
			}),
			...
			(u.prototype.update = function () {
				...
				if (0 != this.lastTimeSec) {
					...
					if (
						...
						var $ =
								0.5 *
								(Math.sqrt(r * r + 16 * r * n - 8 * r * n) - r),
							p = Math.sqrt(
								this.faceVX * this.faceVX +
									this.faceVY * this.faceVY
							);
						p > $ &&
							((this.faceVX *= $ / p), (this.faceVY *= $ / p)),
			...
			!(function () {
				...
				(e._$0s = 1),
					...
					(e.prototype.getParamFloat = function (t) {
						return (
							"number" != typeof t &&
								(t = this._$5S.getParamIndex(l.getID(t))),
							...
							for (
								n[0] = 0,
									...
									e.gl.bindFramebuffer(
										e.gl.FRAMEBUFFER,
										tt.frameBuffers[this.curFrameNo]
											.framebuffer
									),
								...
								var a = (s = this.clipContextList[r])
										.allClippedDrawRect,
								...
								for (
									var f = s.clippingMaskDrawIndexList.length,
										c = 0;
									c < f;
									c++
								) {
					...
					(i.prototype.setupLayoutBounds = function (t) {
						...
						for (var s = 0, o = 0; o < i.CHANNEL_COUNT; o++) {
							...
							if (0 == n);
								...
								(($ =
									this.clipContextList[s++]).layoutChannelNo =
									o),
									($.layoutBounds.x = 0),
									($.layoutBounds.y = 0),
					...
					(y.prototype._$F0 = function (t) {
						(this._$fL = t._$_T()),
							...
							(this._$qT = t._$_T()),
							t.getFormatVersion() >=
								F.LIVE2D_FORMAT_VERSION_V2_10_SDK2 &&
					...
					(T._$Z2 = function (t, e, i, r) {
						...
						for (
							var U = 1 << s, Y = new Float32Array(U), G = 0;
							G < U;
							G++
						) {
						...
						for (var H = new Float32Array(U), z = 0; z < U; z++)
							H[z] = r[o[z]];
						var q = 0;
					...
					(T._$Vr = function (t, e, i, r, s, o, n, a) {
						...
						if (_ <= 0) {
							...
							for (
								var Mt = 1 << _,
									Et = new Float32Array(Mt),
									xt = 0;
								xt < Mt;
								xt++
							) {
								for (var At = xt, wt = 1, Ot = 0; Ot < _; Ot++)
									(wt *= At % 2 == 0 ? 1 - l[Ot] : l[Ot]),
										(At /= 2);
								Et[xt] = wt;
							}
							for (
								var It = new Float32Array(Mt), Dt = 0;
								Dt < Mt;
								Dt++
							)
								It[Dt] = s[h[Dt]];
					...
					(L.prototype.setClipBufPre_clipContextForMask = function (
						t
					) {
					...
					(L.prototype.setClipBufPre_clipContextForDraw = function (
						t
					) {
					...
					(M.prototype.interpolateOpacity = function (t, e, i, r) {
						null == this._$mS
							...
							: i.setInterpolatedOpacity(
									T._$br(t, e, r, this._$mS)
							  );
					}),
					...
					(w.prototype._$Ur = function (t) {
						if (t._$WS()) return !0;
						for (
							var e = t._$v2(), i = this._$Ob.length - 1;
							i >= 0;
							--i
						) {
						...
						for (
							...
							if (
								((i = _.getParamIndex(o)) == x._$ds &&
									((i = t.getParamIndex(_.getParamID())),
									_._$Pb(i, o)),
								i < 0)
							)
								throw new Exception(
					...
					(C.prototype.init = function () {
						...
						for (
							...
							for (
								var _ = a.getBaseData(), h = _.length, l = 0;
								l < h;
								++l
							)
								s.push(_[l]);
				...
				(b.prototype = new L()),
						...
						if (this._$GS._$Ur(t)) {
							...
							if ((this._$GS._$zr(o, n, s), s <= 0)) {
								...
								(i._$Yr._$fL = a._$fL + (_._$fL - a._$fL) * h),
									(i._$Yr._$gL =
										a._$gL + (_._$gL - a._$gL) * h),
									(i._$Yr._$B0 =
										a._$B0 + (_._$B0 - a._$B0) * h),
									(i._$Yr._$z0 =
										a._$z0 + (_._$z0 - a._$z0) * h),
									(i._$Yr._$qT =
										a._$qT + (_._$qT - a._$qT) * h);
							} else if (2 == s) {
								...
								for (
									var W = 0 | Math.pow(2, s),
										j = new Float32Array(W),
										J = 0;
									J < W;
									J++
								) {
					...
					(N.prototype._$2b = function (t, e) {
						...
						if ((i._$hS(!0), this._$32())) {
							...
							if (
								(i._$8r == M._$ur &&
									(i._$8r = t.getBaseDataIndex(r)),
								i._$8r < 0)
							)
								tt._$so && a._$li("_$L _$0P _$G :: %s", r),
									i._$hS(!1);
							else {
								...
								if (null != s) {
									...
									s._$nb(t, o, n, n, 1, 0, 2),
										...
										(i._$Wr._$qT =
											i._$Yr._$qT - l * ct._$NS);
									var $ = o.getTotalScale();
									i.setTotalScale_notForClient(
										$ * i._$Wr._$B0
									);
									var u = o.getTotalOpacity();
									i.setTotalOpacity(
										u * i.getInterpolatedOpacity()
									),
					...
					(N.prototype._$Jr = function (t, e, i, r, s, o) {
						...
						(N._$Lo[0] = r[0]),
							(N._$Lo[1] = r[1]),
							e._$nb(t, i, n, n, 1, 0, 2);
						for (
							var a = N._$To, _ = N._$Po, h = 1, l = 0;
							l < 10;
							l++
						) {
							if (
						...
						for (
							...
							if (_._$RP == k._$hs) {
								...
								var u = t.getParamIndex(l),
									...
									f =
										0.4 *
										(p.getParamMax(u) - p.getParamMin(u)),
									c = p.getParamFloat(u),
									d = _._$I0[o >= h ? h - 1 : o],
					...
					(H.transformPoints_sdk2 = function (
						e,
						i,
						r,
						s,
					...
					(tt.setupProfile = function (t, e) {
						for (var i in (arguments.length < 2 && (e = !0), t))
							tt[i] = t[i];
					}),
					(tt.init = function () {
					...
					(rt.prototype._$2b = function (t, e) {
						try {
							...
							if (
								!i &&
								(U.prototype._$2b.call(this, t), this._$32())
							) {
								var s = this.getTargetBaseDataID();
								if (
									(r._$8r == U._$ur &&
										(r._$8r = t.getBaseDataIndex(s)),
									r._$8r < 0)
								)
					...
					(nt.prototype.startMotion = function (t, e) {
						for (
							var i = null, r = this.motions.length, s = 0;
							s < r;
							++s
						)
					...
					(ht._$2o = function () {
						return (
							null == ht._$eT && (ht._$eT = ht.getID("DST_BASE")),
							ht._$eT
						);
					}),
					(ht.getID = function (t) {
						var e = ht._$tP[t];
						return (
							null == e && ((e = new ht(t)), (ht._$tP[t] = e)), e
						);
					}),
					(lt.prototype = new L()),
					...
					(lt.prototype.compileShader = function (t, e) {
						...
						if (
							...
							return (
								a._$Ji("_$L0 to compile shader : " + o),
								i.deleteShader(s),
								null
							);
						}
					...
					(lt.prototype.loadShaders2 = function () {
						...
						if (
							...
							return (
								a._$Ji("OffFragment shader compile _$li!"), !1
							);
						if (
							(t.attachShader(
								this.shaderProgram,
				...
				(ft.prototype._$bT = function () {
					...
					(ft.prototype._$cS = function () {
						this._$zT();
						for (
							var t = this._$3L(), e = new Int32Array(t), i = 0;
							i < t;
							i++
						)
	...
	function (t, e, i) {
		...
		(s.prototype = new o.L2DBaseModel()),
			(s.prototype.load = function (t, e, i) {
				...
				this.modelSetting.loadModelSetting(e, function () {
					...
					r.loadModelData(t, function (t) {
						for (
							var e = 0;
							e < r.modelSetting.getTextureNum();
							e++
						) {
							if (
								/^https?:\/\/|^\/\//i.test(
									r.modelSetting.getTextureFile(e)
								)
							)
							...
							r.loadTexture(e, s, function () {
								if (r.isTexLoaded) {
									...
									if (
										...
										null != o.width &&
											r.modelMatrix.setWidth(o.width),
											null != o.height &&
												r.modelMatrix.setHeight(
													o.height
												),
											null != o.x &&
												r.modelMatrix.setX(o.x),
											null != o.y &&
												r.modelMatrix.setY(o.y),
											null != o.center_x &&
											...
											null != o.top &&
												r.modelMatrix.top(o.top),
											null != o.bottom &&
												r.modelMatrix.bottom(o.bottom),
											null != o.left &&
												r.modelMatrix.left(o.left),
											null != o.right &&
												r.modelMatrix.right(o.right);
									}
									if (
										null !=
			...
			(s.prototype.preloadMotionGroup = function (t) {
				for (
					var e = this, i = 0;
					i < this.modelSetting.getMotionNum(t);
					i++
				) {
			...
			(s.prototype.update = function () {
				if (null != this.live2DModel) {
					var t =
						((UtSystem.getUserTimeMSec() - this.startTimeMSec) /
							1e3) *
						2 *
						Math.PI;
					this.mainMotionManager.isFinished() &&
						...
						null == this.expressionManager ||
							...
							this.expressionManager.updateParam(
								this.live2DModel
							),
					...
					a.default.DEBUG_LOG && console.error("Failed to update.");
			}),
			...
			(s.prototype.hitTest = function (t, e, i) {
				for (
					var r = this.modelSetting.getHitAreaNum(), s = 0;
					s < r;
					s++
				)
